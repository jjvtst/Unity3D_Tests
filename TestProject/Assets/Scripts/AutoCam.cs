...
namespace TestProject
{
	public class AutoCam : MonoBehaviour
	{
		...
		public bool m_AutoTargetPlayer = false;                      // Whether the rig should automatically target the player.
		public UpdateType m_UpdateType = UpdateType.FixedUpdate;    // stores the selected update type

		// public Vector3 m_TargetOffset = new Vector3(0,1,0);
		public Vector3 m_TargetOffset = default( Vector3 );
		...
		void Start()
		{
			...
			targetRigidbody = m_Target.GetComponent<Rigidbody2D>();
		}
		...
		void FollowTarget( float deltaTime )
		{
			...
			transform.position = Vector3.Lerp( transform.position, m_Target.position + m_TargetOffset, deltaTime * m_MoveSpeed );
