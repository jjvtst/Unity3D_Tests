...
class RD_RendererGL::Impl
{
  friend class RD_RendererGL;
...
void RD_RendererGL::shutdown()
{
  //  Nothing to do!
}

void RD_RendererGL::setDevice( void * /*device*/, int /*eventType*/ )
{
  //  Nothing to do!
}

void RD_RendererGL::cleanup()
{
...
void RD_RendererGL::beginRender()
{
...
void RD_RendererGL::endRender()
{
}

void RD_RendererGL::setMatrices( const Math::Matrix4x4 &projectionMatrix, const Math::Matrix4x4 &modelViewMatrix )
{
...
void RD_RendererGL::beginSpriteSheet( const RD_SpriteSheetPtr_t &pSpriteSheet )
{
...
void RD_RendererGL::endSpriteSheet()
{
  glDisable( GL_TEXTURE_2D );
}

void RD_RendererGL::beginComposition( const RD_RenderScriptPlainPtr_t &pRenderScript )
{
...
void RD_RendererGL::endComposition( const RD_RenderScriptPlainPtr_t &/*pRenderScript*/ )
{
...
void RD_RendererGL::beginComposition( const RD_RenderScriptFxPtr_t &pRenderScript )
{
...
void RD_RendererGL::endComposition( const RD_RenderScriptFxPtr_t &/*pRenderScript*/ )
{
  glDisableClientState(GL_VERTEX_ARRAY);
  glDisableClientState(GL_TEXTURE_COORD_ARRAY);
  glDisableClientState(GL_COLOR_ARRAY);
...
void RD_RendererGL::beginBatch( const RD_RenderScriptFx::RenderBatch &/*renderBatch*/ )
{
  //  Nothing to do in legacy opengl renderer!
}

void RD_RendererGL::endBatch( const RD_RenderScriptFx::RenderBatch &/*renderBatch*/ )
{
  //  Nothing to do in legacy opengl renderer!
}

void RD_RendererGL::renderScriptToTexture( const RD_RenderScriptPtr_t& /*pRenderScript*/, const Rect& /*rect*/, float /*scale*/, TexturePtr_t /*texture*/ )
{
  //  Not supported by legacy opengl renderer!
}

void RD_RendererGL::renderScript( const RD_RenderScriptPtr_t &pRenderScript, const Math::Matrix4x4 &projectionMatrix, const Math::Matrix4x4 &modelViewMatrix )
{
  pRenderScript->render( this, projectionMatrix, modelViewMatrix );
}

void RD_RendererGL::renderVertices( unsigned short *indices, unsigned indexOffset, unsigned nIndices, unsigned /*vertexOffset*/, unsigned /*nVertices*/ )
{
  if ( nIndices > 0u )
  {
...
void RD_RendererGL::renderVertices( unsigned int *indices, unsigned indexOffset, unsigned nIndices, unsigned /*vertexOffset*/, unsigned /*nVertices*/ )
{
  if ( nIndices > 0u )
  {
