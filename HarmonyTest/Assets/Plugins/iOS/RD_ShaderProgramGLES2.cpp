...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#if 0
#pragma mark - RD_ShaderProgramGLES2
#endif

RD_ShaderProgramGLES2::RD_ShaderProgramGLES2()
{
}
...
class RD_ShaderProgramPlainGLES2::Impl
{
  friend class RD_ShaderProgramPlainGLES2;
...
void RD_ShaderProgramPlainGLES2::load()
{
  ...
  compileShader( &_i->_vertShader, GL_VERTEX_SHADER, g_defaultVertShader_glsl );
  compileShader( &_i->_fragShader, GL_FRAGMENT_SHADER, g_defaultFragShader_glsl );
...
void RD_ShaderProgramPlainGLES2::unload()
{
  glDeleteProgram(_i->_program);
  _i->_program = 0;
}

void RD_ShaderProgramPlainGLES2::activate()
{
  load();
  glUseProgram(_i->_program);
}

void RD_ShaderProgramPlainGLES2::deactivate()
{
  glUseProgram(0);
}

void RD_ShaderProgramPlainGLES2::setMatrix( const float *matrix )
{
  glUniformMatrix4fv( _i->_uniforms[OGL_UNIFORM_MVP_MATRIX], 1, false, matrix );
}

void RD_ShaderProgramPlainGLES2::setTextureSampler0( int activeTexture )
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#if 0
#pragma mark - RD_ShaderProgramFxGLES2::Impl
#endif

class RD_ShaderProgramFxGLES2::Impl
{
  friend class RD_ShaderProgramFxGLES2;
...
void RD_ShaderProgramFxGLES2::load()
{
  //  Shaders were already loaded.
  if ( _i->_program != 0 )
    return;
  ...
  //  2. Compile vertex and fragment shader and attach to program.
  compileShader( &_i->_vertShader, GL_VERTEX_SHADER, g_fxVertShader_glsl );
  compileShader( &_i->_fragShader, GL_FRAGMENT_SHADER, g_fxFragShader_glsl );
...
void RD_ShaderProgramFxGLES2::unload()
{
  glDeleteProgram(_i->_program);
  _i->_program = 0;
}

void RD_ShaderProgramFxGLES2::activate()
{
  load();
  glUseProgram(_i->_program);
}

void RD_ShaderProgramFxGLES2::deactivate()
{
  glUseProgram(0);
}

void RD_ShaderProgramFxGLES2::setMatrix( const float *matrix )
{
  glUniformMatrix4fv( _i->_uniforms[OGL_UNIFORM_MVP_MATRIX], 1, false, matrix );
}

void RD_ShaderProgramFxGLES2::setTextureSampler0( int texture )
{
  glUniform1i( _i->_uniforms[OGL_UNIFORM_TEXTURE_0], texture );
}

void RD_ShaderProgramFxGLES2::setTextureSampler1( int texture )
{
  glUniform1i( _i->_uniforms[OGL_UNIFORM_TEXTURE_1], texture );
}

void RD_ShaderProgramFxGLES2::setBoneMatrices( const float *matrixArray, unsigned count )
{
